...
<form action="/event" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group row m-2 border">
        ...
        <div class="col-sm-10">
            <input class="form-control" type="text" id="title" name="title" placeholder="Give your event a title!"><br>
        </div>
        <label for="descr" class="col-sm-2 col-form-label">Event Description:</label>
        <div class="col-sm-10">
            <textarea class="form-control" type="text" id="descr" name="descr" placeholder="Tell us what is your event about!"></textarea><br>
        </div>
