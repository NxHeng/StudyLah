                ...
                @foreach ($events as $event)
                    <div class="m3 col-sm-12 col-md-6 col-lg-6">
                        ...
                        <div class="card m-2 p-3 ">
                            <div class="text-center h4" style="text-transform: Uppercase; font-weight:bold; font-family: 'cursive', Monospace;">
                                {{ $event->event_title }}
                            </div>
                            <div class="text-left">
                                <div class="description">
                                WHAT IS IT ABOUT? <br> <p>{{ $event->event_text }} </p>
                                </div>
                ...
                @foreach ($events_own as $event)
                    <div class="col-sm-12 col-md-6 col-lg-6">
                        ...
                        <div class="text-center m-2">
                            ...
                            <div class="card-body ">
                            <h4 class="text-center style="text-transform: Uppercase; font-weight:bold; font-family: 'cursive', Monospace;">
